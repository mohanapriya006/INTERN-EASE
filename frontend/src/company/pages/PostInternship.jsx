...
const PostInternship = () => {
  ...
  return (
    <div className="dashboard-container">
      ...
      <header className="dashboard-header" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "10px" }}>
      <div className="profile" style={{ marginLeft: "auto" }}>Profile</div>
      </header>
